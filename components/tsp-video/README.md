...
- 2.h5、小程序分页请求数据最少大于等于5条，不然会出现一些小问题

## 说明
- 免费使用
- 支持H5、小程序、APP(nvue)、当前是vue2版本，vue3则需要购买源码版本
...
## 源码
- 源码版本有：添加视频、删除视频、评论区功能、自定义全屏样式、自定义全屏，全屏后可以上下滑动播放
- 示例视频播放核心源代码已加密，需要核心源代码的可联系我，开发不易，源代码需要额外赞助一下才单独开放
- 线下联系我
- qq：1670280472
- wx：thrmmkk123
